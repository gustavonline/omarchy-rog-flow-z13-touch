/* Generated Danish XKB keymap, checked in for reproducible offline builds. */
#define NUMKEYMAPS 2
...
\
        ...
        key <AE04>               {	[               4,        currency, F4 ] };\
        key <AE05>               {	[               5,         percent, F5 ] };\
        key <AE06>               {	[               6,       ampersand, F6 ] };\
        key <AE07>               {	[               7,           slash, F7 ] };\
        key <AE08>               {	[               8,       parenleft, F8 ] };\
        key <AE09>               {	[               9,      parenright, F9 ] };\
        key <AE10>               {	[               0,           equal, F10 ] };\
        key <AE11>               {	[            plus,        question, EuroSign ] };\
        key <AE12>               {	[      dead_acute,      dead_grave, sterling ] };\
        ...
        key <AB07>               {	[               m,               M, exclam ] };\
        key <AB08>               {	[           comma,       semicolon, backslash] };\
        key <AB09>               {	[          period,           colon, bar ] };\
